  ...
  return (
    <footer className="footer">
      ...
      <ul className="filters">
        <li>
          <a onClick={() => { setStatus("all"); }} className={`${status === "all" ? "selected" : ""}`}>
            All
          </a>
        </li>
        <li>
          <a
            onClick={() => { setStatus("active") }} className={`${status === "active" ? "selected" : ""}`}>
            Active
          </a>
        </li>
        <li>
          <a onClick={() => { setStatus("completed") }} className={`${status === "completed" ? "selected" : ""}`}>
            Completed
          </a>
        </li>
      </ul>
